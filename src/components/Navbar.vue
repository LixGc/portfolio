    ...
    <nav class="block w-full sticky top-0 z-10 transition-all duration-300"
        ...
        <div class="flex flex-wrap items-center justify-between px-9 md:py-4 bg-white/[.9] dark:bg-slate-900 backdrop-blur-sm transition-shadow duration-300"
            ...
            <router-link to="/#landing-page">
                <div
                    :class="['transition-all motion-reduce:transition-none duration-500', showTransition ? 'opacity-1 blur-0' : 'opacity-0 blur-sm']">
                    <div v-if="!portfolio.greeting.logo.custom">
                        <img :src="getImageUrl(portfolio.greeting.logo.link)"
                            class="scale-75 md:scale-100 origin-left drop-shadow-lg" id="logo-img" />
                    </div>
                    <!-- Custom Logo -->
                    <div v-else>
                        <div
                            ...
                            <p>&lt;</p>
                            <p class="text-5xl md:text-7xl" id="custom-logo">F.G.</p>
                            <p>/></p>
                        </div>
                    </div>
                </div>
                ...
                <ul class="font-medium flex flex-col p-4 xl:p-0 mt-4 xl:flex-row xl:space-x-8 xl:mt-0">
                    <li
                        ...
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color"
                            to="/#about-section">About</router-link>
                    </li>
                    <li
                        ...
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color"
                            to="/#experience-section">Experience</router-link>
                    </li>
                    <li
                        ...
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#work-section">My
                            Projects</router-link>
                    </li>
                    <li
                        :class="['transition-all motion-reduce:transition-none duration-500 delay-[200ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color"
                            to="/#contact-section">Contact</router-link>
                    </li>
                    <li
        ...
        <NavTransition>
            <div v-show="dropDownActive"
                ...
                <ul>
                    ...
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#experience-section">🛡️
                            Experience</router-link>
                    </li>
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#work-section">💻 My
                            Projects</router-link>
                    </li>
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#contact-section">📭
                            Contact</router-link>
                    </li>
                    <li>
                        <a :href="portfolio.greeting.resumeLink" target="_blank">
                            <button
                                class="block w-full text-center bg-button-color py-2 px-6 mt-5 shadow-sm shadow-button-color focus:bg-button-color focus:text-white active:bg-button-color active:text-white text-white">Resume</button>
                        </a>
                    </li>
                    <li>
